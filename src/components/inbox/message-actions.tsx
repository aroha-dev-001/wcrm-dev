  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "absolute -top-3.5 z-10 flex h-7 items-center gap-0.5 rounded-md bg-popover px-1 shadow-popover transition-opacity",
      ...
      >
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          <PopoverTrigger
            className="flex size-6 cursor-pointer items-center justify-center rounded-[5px] text-muted-foreground hover:bg-accent hover:text-foreground"
            aria-label={t("react")}
          >
          ...
          >
            {QUICK_EMOJIS.map((e) => (
              <button
                ...
                className="flex size-8 cursor-pointer items-center justify-center rounded-md text-lg leading-none hover:bg-accent"
