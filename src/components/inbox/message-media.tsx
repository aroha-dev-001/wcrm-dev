...
function MediaActionButton({
  ...
  return (
    <button
      ...
      className="flex h-7 w-7 items-center justify-center rounded-full border border-border bg-background/95 text-foreground shadow-sm transition-colors hover:bg-background disabled:opacity-60"
    >
      {busy ? (
